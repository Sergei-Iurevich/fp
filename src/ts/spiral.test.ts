...
describe("testing function spiral", () => {
    it("test for data set №1", () => {
        ...
        const outputArray = [0, 1, 2, 3, 4, 9, 14, 19, 18, 17, 16, 15, 10, 5, 6, 7, 8, 13, 12, 11];
    ...
    it("test for data set №2", () => {
        ...
        const outputArray = [0, 1, 2, 3, 4, 9, 14, 19, 24, 23, 22, 21, 20, 15, 10, 5, 6, 7, 8, 13, 18, 17, 16, 11, 12];
        expect(spiral(inputArray)).toEqual(outputArray);
    });
